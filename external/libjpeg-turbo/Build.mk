...
LOCAL_MODULE_GEN_SHARED_FILES=.libs/libjpeg.so .libs/libjpeg.so.8 .libs/libjpeg.so.8.0.2 .libs/libturbojpeg.so
...
LOCAL_MODULE_CONFIG=./autogen.sh;./configure --host=$(DEVICE_COMPILER_PREFIX) --with-jpeg8
