...
#define GPIO_WAKEUP_KEY            GPIO_PB(6)
#define ACTIVE_LOW_WAKEUP      0

/* ****************************GPIO KEY END********************************** */

#define SUSPEND_WAKEUP_KEY      GPIO_WAKEUP_KEY       /* suspend wakeup key */
#define SUSPEND_WAKEUP_KEY_TRIGGER_EDGE    0 /* wakeup trigger, 0: Falling edge, 1: rising edge */
