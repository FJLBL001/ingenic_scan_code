...
ifeq ($(use_ula), 1)
LOCAL_SPEECH_MODULE=aiengine-4mic
else
LOCAL_SPEECH_MODULE=aiengine-1mic
endif

LOCAL_MODULE = $(LOCAL_SPEECH_MODULE)
...
LOCAL_DEPANNER_MODULES += $(LOCAL_SPEECH_MODULE)-d
...
# copy the bin
include $(CLEAR_VARS)
LOCAL_MODULE=$(LOCAL_SPEECH_MODULE)-d
LOCAL_MODULE_TAGS :=optional
LOCAL_MODULE_CLASS:=DIR
LOCAL_MODULE_PATH := $(TARGET_FS_BUILD)/$(TARGET_TESTSUIT_DIR)/$(LOCAL_SPEECH_MODULE)
