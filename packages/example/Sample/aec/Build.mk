...
LOCAL_DEPANNER_MODULES:= hardware_inc alsa-include libhardware libwebrtc_audio_preprocessing
...
LOCAL_COPY_FILES:= \
		usr/lib/libwebrtc_audio_preprocessing.so:lib/libwebrtc_audio_preprocessing.so
