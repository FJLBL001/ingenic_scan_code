...
#name of the module:
LOCAL_MODULE = my_zxing
LOCAL_MODULE_TAGS := user           #Development mode of module ,userdebug,eng,optional
...
GPIO_SRC_FILES := gpio/scangpio.cpp

POWER_SRC_FILES := power/scanpower.cpp

PWN_SRC_FILES := pwm/scanpwm.cpp

SERIAL_SRC_FILES := serial/scanserial.cpp

VIDEO_SRC_FILES := video/scanvideo.cpp

PARAM_SRC_FILES := param/scanparam.cpp

SPM_SRC_FILES := spm/scanspm.cpp
...
VIDEO_INC_FILES := video

PARAM_INC_FILES := param

SPM_INC_FILES := spm

LOCAL_SRC_FILES := $(ZXING_SRC_FILES) $(ZBAR_SRC_FILES) $(GPIO_SRC_FILES) $(POWER_SRC_FILES) $(PWN_SRC_FILES) $(SERIAL_SRC_FILES) $(VIDEO_SRC_FILES) $(PARAM_SRC_FILES) $(SPM_SRC_FILES) DecodeEntry.cpp main.cpp        #compiled src files
...
LOCAL_LDLIBS := -lstdc++ -lpthread  -lrt -lc -lm

LOCAL_C_INCLUDES :=                          #include files
LOCAL_CPP_INCLUDES:=  $(ZXING_INC_FILES) $(ZBAR_INC_FILES) $(GPIO_INC_FILES) $(POWER_INC_FILES) $(PWN_INC_FILES) $(SERIAL_INC_FILES) $(VIDEO_INC_FILES) $(PARAM_INC_FILES) $(SPM_INC_FILES)                       #cpp include files
