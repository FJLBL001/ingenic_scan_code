...
VIDEO_SRC_FILES := video/scanvideo.c

PARAM_SRC_FILES := param/scanparam.c
...
LOCAL_SRC_FILES := $(ZXING_SRC_FILES) $(ZBAR_SRC_FILES) $(GPIO_SRC_FILES) $(POWER_SRC_FILES) $(PWN_SRC_FILES) $(SERIAL_SRC_FILES) $(VIDEO_SRC_FILES) $(PARAM_SRC_FILES) DecodeEntry.cpp main.cpp        #compiled src files
...
LOCAL_CPP_INCLUDES:=  $(ZXING_INC_FILES) $(ZBAR_INC_FILES) $(GPIO_INC_FILES) $(POWER_INC_FILES) $(PWN_INC_FILES) $(SERIAL_INC_FILES) $(VIDEO_INC_FILES) $(PARAM_INC_FILES)                       #cpp include files
