...
enum opt_code
{
  ...
  OPT_mmxu = 1212,                           /* -mmxu */
  OPT_mnan_ = 1213,                          /* -mnan= */
  OPT_mno_float = 1214,                      /* -mno-float */
  OPT_mno_flush_func = 1215,                 /* -mno-flush-func */
  OPT_mno_mdmx = 1216,                       /* -mno-mdmx */
  OPT_mno_mips16 = 1217,                     /* -mno-mips16 */
  OPT_mno_mips3d = 1218,                     /* -mno-mips3d */
  OPT_modd_spreg = 1219,                     /* -modd-spreg */
  OPT_mpaired_single = 1220,                 /* -mpaired-single */
  OPT_mplt = 1221,                           /* -mplt */
  OPT_mr10k_cache_barrier_ = 1222,           /* -mr10k-cache-barrier= */
  OPT_mrelax_pic_calls = 1223,               /* -mrelax-pic-calls */
  OPT_mshared = 1224,                        /* -mshared */
  OPT_msingle_float = 1225,                  /* -msingle-float */
  OPT_mslsa = 1226,                          /* -mslsa */
  OPT_msmartmips = 1227,                     /* -msmartmips */
  OPT_msoft_float = 1228,                    /* -msoft-float */
  OPT_msplit_addresses = 1229,               /* -msplit-addresses */
  OPT_msym32 = 1230,                         /* -msym32 */
  OPT_msynci = 1231,                         /* -msynci */
  OPT_mtune_ = 1232,                         /* -mtune= */
  OPT_muclibc = 1233,                        /* -muclibc */
  OPT_muninit_const_in_rodata = 1234,        /* -muninit-const-in-rodata */
  OPT_mvirt = 1235,                          /* -mvirt */
  OPT_mvr4130_align = 1236,                  /* -mvr4130-align */
  OPT_mxgot = 1237,                          /* -mxgot */
  OPT_mxpa = 1238,                           /* -mxpa */
  OPT_n = 1239,                              /* -n */
  OPT_no_canonical_prefixes = 1240,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1241,              /* -no-integrated-cpp */
  OPT_noasmopt = 1242,                       /* -noasmopt */
  ...
  OPT_profile = 1269,                        /* -profile */
  OPT_pthread = 1270,                        /* -pthread */
  OPT_quiet = 1271,                          /* -quiet */
  OPT_r = 1272,                              /* -r */
  OPT_rdynamic = 1273,                       /* -rdynamic */
  ...
  OPT_time = 1336,                           /* -time */
  OPT_time_ = 1337,                          /* -time= */
  OPT_tno_android_cc = 1338,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1339,                 /* -tno-android-ld */
