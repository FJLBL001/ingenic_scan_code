...
#nor flash config
UBOOT_BUILD_CONFIG := halley2_uImage_sfc_nor
KERNEL_BUILD_CONFIG := halley2_linux_nor_defconfig
...
#nand flash config
UBOOT_BUILD_CONFIG :=  halley2_uImage_sfc_nand
...
#mmc config
UBOOT_BUILD_CONFIG :=  halley2_uImage_msc0
KERNEL_BUILD_CONFIG :=
KERNEL_TARGET_IMAGE :=uImage
KERNEL_IMAGE_PATH:=arch/mips/boot
