...
#nor flash config
UBOOT_BUILD_CONFIG := phoenix_uImage_sfc_nor
...
UBOOT_BUILD_CONFIG := phoenix_xImage_sfc_nor
...
#nand flash config
UBOOT_BUILD_CONFIG :=  phoenix_uImage_sfc_nand
...
#mmc config
UBOOT_BUILD_CONFIG :=  phoenix_uImage_msc0
KERNEL_BUILD_CONFIG :=
KERNEL_TARGET_IMAGE :=uImage
KERNEL_IMAGE_PATH:=arch/mips/boot
